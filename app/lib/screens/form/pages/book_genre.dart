...
class BookGenres extends StatelessWidget {
  ...
  const BookGenres({required this.formContext, super.key});

  @override
  Widget build(BuildContext context) {
    formContext
        .read<FormBloc>()
        .add(const EmitEvent(status: FormStatus.bookGenres));
    return Column(
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Padding(
              ...
              child: FormCheckbox(
                checkboxList: formContext.read<FormBloc>().state.bookGenres,
                checkboxImages: null,
