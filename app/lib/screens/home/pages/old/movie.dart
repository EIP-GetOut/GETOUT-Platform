...
import 'package:getout/screens/home/pages/old/movie_description.dart';
        ...
        body: Column(children: [
          ...
          Flexible(
            child: Padding(
              ...
              child:
                  Text(infoMovie?.overview ?? 'Aucune description disponible',
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          MovieDescriptionPage(movie: infoMovie)));
            },
            child: const Text(
              'voir plus >',
