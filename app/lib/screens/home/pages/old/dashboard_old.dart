...
import 'package:getout/screens/home/pages/old/movie.dart';
...
class _DashboardPageState extends State<DashboardPage> {
        ...
        body: Column(children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              const Text('Les livres qui vous passionneront',
                  style: TextStyle(
                    color: Color(0xFFD55641),
                    fontSize: 23,
                    fontFamily: 'Urbanist',
  ...
  Future<void> getMovies() async {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      RequestsService.instance.generateMovies(request);
    });
  }
