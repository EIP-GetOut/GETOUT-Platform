...
3. You can access the coverage by opening the following generated file :
   ```bash
...
# Functional Tests
Functional tests can be found on the Postman of the organization and are therefor not managed by this repository.